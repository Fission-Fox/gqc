...
export default function MissionItem({ title, description }: Prop) {
  return (
    <div className="w-full flex  justify-center items-start gap-5 group  transition duration-300">
      <div className="w-[65px!important] h-[65px!important] bg-[#19315B] rounded-[50%] p-3">
        <TrendingUpIcon
      ...
      <div className="flex flex-col w-[70%]">
        <div>
          ...
          <span className="block max-w-[50px] group-hover:max-w-[80px] transition-all duration-500 h-[3px] bg-[#19315B] mt-1"></span>
        </div>
