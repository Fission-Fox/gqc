...
import bg from "../../assets/images/bg/cta.png";
const images = [
            ...
            {projectList.map((item, index) => (
              ...
              >
                <Image
                  ...
                  width={262}
                  height={196}
                  className="w-auto group-hover:origin-center group-hover:scale-110 group-hover:rotate-3 transition duration-500"
                  alt="workimage"
                />
                ...
                <div className="content">
                  ...
                  <div className="absolute z-10 opacity-0 group-hover:opacity-100 bothrefm-4 start-4 transition-all duration-500">
                    <Link
                      href="#"
