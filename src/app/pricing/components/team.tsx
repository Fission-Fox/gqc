...
// import '../../../assets/images/client/01.jpg' from "@/assets/images/client/01.jpg";
      ...
      >
            ...
            {team.map((member, index) => (
              ...
              >
                <Image
                  ...
                  width={100}
                  height={100}
                  className="!w-[100%] !h-[100%] group-hover:origin-center group-hover:scale-105 transition duration-500"
                  alt=""
                />
        ...
        <div className="container mt-12">
          <div className="grid md:grid-cols-6 grid-cols-2 justify-center gap-8">
            ...
            <div className="mx-auto">
              <Image src={GoogleImage} className="h-[25px]" alt="" />
            </div>

            <div className="mx-auto">
              <Image src={LenovoImage} className="h-[25px]" alt="" />
            </div>

            <div className="mx-auto">
              <Image src={PaypalImage} className="h-[25px]" alt="" />
            </div>

            <div className="mx-auto">
              <Image src={ShopifyImage} className="h-[25px]" alt="" />
            </div>

            <div className="mx-auto">
              <Image src={SpotifyImage} className="h-[25px]" alt="" />
            </div>
          </div>
        </div>
        {/* <!--end container--> */}
